...
class SimpleAnimation(object):
    """ A simple animation. Scrolls cyclically through a list of
        images, drawing them onto the screen in the same position.
    """
    def __init__(self, screen, pos, images, duration, scroll_speed):
        """ Create an animation.
        ...
        self.active = True
        self.img_ptr = 0
        self.scroll_timer = Timer(self.scroll_speed, self._advance_img)
        self.active_timer = Timer(self.duration, self._inactivate)
