...
class Button(object):
    ...
    def __init__(self, surface, pos, btntype, imgnames, attached, text="", textcolor=(0, 0, 0)):
        self.surface = surface
        self.pos = pos
        self.btntype = btntype
        self.imgs = [pygame.image.load(img).convert_alpha() for img in imgnames]
        self.img = self.imgs[0]
        self.imgwidth, self.imgheight = self.img.get_size()
        self.rect = pygame.Rect(self.pos.x, self.pos.y, self.imgwidth, self.imgheight)
        ...
        self.textRect = pygame.Rect(self.pos.x + self.imgwidth / 2 - self.textSize.x / 2, self.pos.y + self.imgheight / 2 - self.textSize.y / 2, 0, 0)
        self.state = False
        self.toggle = False
